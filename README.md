...
Run with the -testnet option to run with "play skeincoins" on the test network, if you
...
Skeincoin Core is a multithreaded application, and deadlocks or other multithreading bugs
