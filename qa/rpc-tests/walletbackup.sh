...
B4ARGS="-datadir=$D4"
$SKEINCOIND $SKEINCOINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$SKEINCOIND $SKEINCOINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $SKEINCOIND $SKEINCOINDARGS $B1ARGS &
  B1PID=$!
  $SKEINCOIND $SKEINCOINDARGS $B2ARGS &
  B2PID=$!
  $SKEINCOIND $SKEINCOINDARGS $B3ARGS &
  B3PID=$!
}
