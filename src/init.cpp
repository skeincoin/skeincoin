...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 11230 or testnet: 27711)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 21230 or testnet: 37711)") + "\n";
...
#endif
    // Make sure only a single Skeincoin process is using the data directory.
