...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    r = CallRPC(string("createrawtransaction ")+prevout+" "+
      "{\"67CPXuRuLSyvbhKfNusouLhRc7H9UYZjJx\":11}");
    string notsigned = r.get_str();
    string privkey1 = "\"aVhL1R8JtasXsnx2iRzzyUfqXtPoxvZk4drdXTBNCbwc6beJzZJc\"";
    string privkey2 = "\"aUXRgtf4UXDRZPwNMQGgCvzCZ6RREKdmEFD6aYCgTht3KhszEamb\"";
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("17999999.9999999")), 1799999999999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("17999999.99999999")), 1799999999999999LL);
