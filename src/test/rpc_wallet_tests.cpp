...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    BOOST_CHECK_THROW(CallRPC("setaccount SZJZtQ9nmffzdsm4rfXUxcYjAQPPpK3u2F nullaccount"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("setaccount"), runtime_error);
    /* 1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4X (33 chars) is an illegal address (should be 34 chars) */
    BOOST_CHECK_THROW(CallRPC("setaccount SMW1bhLXNQVgKRMS9kDcxJrxpHrafZVmop nullaccount"), runtime_error);
    ...
    /* Illegal address */
    BOOST_CHECK_THROW(CallRPC("verifymessage SMW1bhLXNQVgKRMS9kDcxJrxpHrafZVmoz " + retValue.get_str() + " mymessage"), runtime_error);
    /* wrong address */
    BOOST_CHECK(CallRPC("verifymessage SZJZtQ9nmffzdsm4rfXUxcYjAQPPpK3u2F " + retValue.get_str() + " mymessage").get_bool() == false);
