...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s skeincoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  skeincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded skeincoin transaction") + "\n" +
              "  skeincoin-tx [options] -create [commands]   " + _("Create hex-encoded skeincoin transaction") + "\n" +
              "\n";
