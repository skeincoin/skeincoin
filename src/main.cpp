...
#if defined(NDEBUG)
# error "Skeincoin cannot be compiled without assertions."
#endif
...
static const int64_t nTargetTimespan = 4 * 120; // 8 minutes
static const int64_t nTargetSpacing = 120; // 2 minutes
static const int64_t nInterval = nTargetTimespan / nTargetSpacing; // 4 blocks

static const int64_t nAveragingInterval = nInterval * 4; // 16 blocks
static const int64_t nAveragingTargetTimespan = nAveragingInterval * nTargetSpacing; // 32 minutes

static const int64_t nMaxAdjustDown = 8; // 8% adjustment down
