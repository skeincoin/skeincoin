...
const char* BIP71_MIMETYPE_PAYMENT = "application/skeincoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/skeincoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/skeincoin-paymentrequest";
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                emit message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Skeincoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
