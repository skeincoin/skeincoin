...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click skeincoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start skeincoin: click-to-pay handler");
    else
...
{
    // clicking on skeincoin: URLs creates FileOpen events on the Mac:
