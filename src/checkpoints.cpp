...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        (323741,  uint256("0x0000000006e4f5bed4e6f2c98fbe39cc50e6238d412217e46988557a0ea3d816"))
        ;
    static const CCheckpointData data = {
        &mapCheckpoints,
        1414604790, // * UNIX timestamp of last checkpoint block
        363707,     // * total number of transactions between genesis and last checkpoint
